...
nicht �ndert, wenn es keinen Modellwechsel gab.
...
Es werden �bergeben:
1. Eine ganzzahlige Note (1-5) f�r den Zustand
2. Der Zeitwert
...
- dann 
erh�ht sich der Zeitwert um den Preis, der f�r diese Extras bezahlt worden ist.

- Sonst
bleibt es beim �bergebenen Zeitwert.
